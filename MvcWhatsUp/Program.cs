...
namespace MvcWhatsUp
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IUsersRepository, DbUsersRepository>(); //Important -- Dependency injection, as I understand is fairly important, the repo needs to be 
